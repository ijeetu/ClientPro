      ...
      <div className="mx-auto max-w-4xl py-16 ">
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <Announcement
            ...
            href="https://github.com/ijeetu"
          />
        </div>
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          Simplify Your ClientProjects with ClientPro!
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600 mb-4">
          Say goodbye to chaotic workflows and hello to seamless project management. ClientPro is your all-in-one solution to manage client tasks, track progress, and deliver projects on time—effortlessly!
          </p>
